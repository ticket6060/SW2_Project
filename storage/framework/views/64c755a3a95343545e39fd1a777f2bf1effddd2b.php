...
<body class="animsition">
    ...
    <header>
    	...
    	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/private-cinema.jpg');">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3 p-b-50">
                    ...
                    <ul>
                        <li class="p-b-10">
                            <a href="outlets.html" class="stext-107 cl7 hov-cl1 trans-04">
								Outlets
							</a>
                        </li>
                    </ul>
...
<?php /* C:\Users\Asmaa\project60600\project6060\resources\views/Movies.blade.php */ ?>